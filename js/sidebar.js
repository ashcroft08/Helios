    ...
    const sidebarHTML = `
        <aside id="sidebar" class="bg-sidebar-dark dark:bg-background-dark border-r border-slate-800/50 dark:border-slate-800/30 text-white w-64 flex-shrink-0 flex flex-col h-screen fixed left-0 top-0 z-50 transition-all duration-300">
            ...
            <nav class="flex-1 px-3 space-y-1 overflow-y-auto">
                ...
                <a href="actividades.html" class="nav-link group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 ${activePage === 'actividades.html' ? 'bg-primary text-white shadow-lg shadow-blue-500/30' : 'text-slate-400 hover:bg-slate-800 hover:text-white'}">
